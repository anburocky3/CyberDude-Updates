...
export default function Login({ isAuthenticated , setIsAuthenticated , loading } : props) {
                                ...
                                <div className="grid grid-cols-3 mt-20">
                                    ...
                                    <div className="flex">
                                        <div className="ml-auto">
                                            <input type="submit" value="Login" className="orange-gradient px-4 text-white cursor-pointer py-2 rounded  font-medium flex items-center text-center"/>
                                        </div>
                                    </div>
                                </div>
                            </form>
